...
/**
 * Created by mugi65 on 2016/06/19.
 */
public class GrowthMessageConstants {
    ...
    public static final int HTTP_CLIENT_DEFAULT_CONNECT_TIMEOUT = 10 * 1000;
    public static final int HTTP_CLIENT_DEFAULT_READ_TIMEOUT = 10 * 1000;
    public static final String PREFERENCE_DEFAULT_FILE_NAME = "growthmessage-preferences";
    public static final long MIN_TIME_FOR_OVERRIDE_MESSAGE =  30 * 1000;
